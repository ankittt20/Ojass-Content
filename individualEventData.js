...
export default individualEventData = [
  ...
  },
  {
    ...
    rules: [
      "Round 1:",
      "This round consists of abstract submission. Write an abstract regarding your groundwork/ awareness campaign, your solution, and relevant statistics. This is an elimination round.",
      "Round 2:",
      "PowerPoint presentation should be prepared along with the video to be presented before the judging panel. There will be a Question Answer round after the presentation in which judges will question about the approach and the solutions discussed. Presentation must contain the names of team members, college name, batch and team name.",
      "Rules:",
  ...
  },
  {
    ...
    rules: [
      ...
      "Round 1:",
      "Select a topic from the topics given. The round consists of abstract submission. Write an abstract regarding the causes of the problem, it’s statistics and suggesting solutions. This round is an elimination round.",
      "Round 2:",
      "A PowerPoint presentation of not more than 12 minutes must be delivered by the team members during the final round. The presentation should contain all the relevant details about the problem and its solution, the innovation in idea, statistics, proper research, etc. There will be a Question Answer round after the presentation in which judges will question about the approach and the solutions discussed. Presentation must contain the names of team members, college name, batch and team name. For further updates please visit our Facebook page:",
    ],
  ...
  },
  {
    ...
    rules: [
      ...
      "Details:",
      "The participants have to do the following:",
      "i. Gound work to analyse the problem. ii.2. Presentation to discuss your solution.In the event, the participants will be provided a location inside our college.(Eg:- Hostel k)They have to analyse all the existing problem in that particular place of our college.They have to write an abstract listing down all such problems.Secondly with their creative mindset they have to suggest the best possible practical solution of all the existing problem. This step must be done in a presentation format.You can also prepare a short video regarding the problem and the place of the problem in the video. This will give you a brownie point.Think critical and provide with a mind blowing solution.",
  ...
  },
  {
    ...
    rules: [
      ...
      "One participant can be on one team only.",
      "Abstract for the preliminary round must be sent to the mail (phocus_nit@nitjsr.ac.in) by 10th April 2023 in a PDF or DOC file.",
      "The first page of the abstract must mention the Team Name, Team Members, And Contact Information of all the members.",
      "Refrain from using vulgarity or obscenity in your advertisement.Advertisement length should not exceed 5min.",
      "For the Finale you will have to submit an Ad film on the given topic of not more than 5min, a poster.",
      "Team Phocus will upload your submitted video on its Facebook page & Youtube Channel.",
      "This is not a presentation round.",
    ],
    prize: [4000, 2500, 1500, 1000],
  ...
  },
  {
    ...
    rules: [
      "All the photographs must be original. Copied or downloaded photos will not be allowed.",
      "All the candidates must register in Ojass'23.",
      "The PDF for the prelims must be mailed to 'phocus_nit@nitjsr.ac.in' with the subject of the mail as Lens View - Your team name latest by 10/04/2023, 11:59 P.M.",
      "Pictures should not contain any watermarks.",
      "The decision of the organising team will be final and binding.",
      "Normal image retouching such as crop, rotation, exposure, contrast, etc. are allowed. Image manipulation is not allowed. ",
      "The themes for the finals round will be disclosed to the selected teams on 11/04/2023.",
  ...
  },
  {
    ...
    rules: [
      "A team can consist of a maximum of 3 members.",
      "Individual participation is also allowed.",
      "The final audio/video is to be submitted to the mail ID: phocus_nit@nitjsr.ac.in .",
      "Participants can use audio and stock videos in background but it should be free from copyright issues.",
      "One can share the audio or video directly or can share the drive link.",
      "The audio/video could stretch up to maximum 4 mins.",
      "Video will get an edge over audio. You can shoot using any camera.",
      "Decision of the organizing team is final.",
      "Team Phocus and Team Ojass have rights to upload your submitted video in their Social Media Handle (Instagram Page, Facebook page, YouTube Channel, etc).",
    ],
    prize: [],
  ...
  },
  {
    ...
    rules: [
      "A team can consist of 3 members at max.",
      "A final video is to be submitted along with Ojass ID and personal details to the mail ID: phocus_nit@nitjsr.ac.in",
      "Any camera is allowed",
      "Decision of the organizing team is final and binding",
      "Team Phocus and Ojass will have all the rights to upload the aftermovie and the reels on official handles.",
    ],
  ...
  },
  {
    ...
    rules: [
      "Avoid alcohol, smoking, guns, blood, communal harmony or any kind of nudity in the film.",
      "A team can be formed from students of any college.",
      "A team can consist of 5 members at max.",
      "A participant can participate in no more than 2 events",
      "Your short film/documentary should not be created before April 7, 2022",
      "Film with languages other than Hindi and English must have subtitles.",
      "The work of filmmaker should be original. No professional help is allowed. This event is for amateurs only.",
      "Don’t take/copy content from other creators. We strictly check for plagiarism.",
      "Short films screened in previous editions of Ojass will not be allowed.",
      "There is no restriction on Genre.",
      "The decision of the organizing team is final and binding",
      "You may use any camera to shoot the film",
    ],
  ...
  },
  {
    ...
    rules: [
      "Each team can contain a maximum of two members or one can participate individually.",
      "The members in a team must be from same year, however the branch may differ.",
      "There will be a separate cut-off for each year.",
      "Both rounds are pen and paper based. ",
      "Any form of unfair means will lead to disqualification.",
    ],
    prize: [4000, 2500, 1500, 1000],
    eventHeadName: ["Pratik Sonthaliya"],
    eventHeadNumber: ["7488362319"],
  ...
  },
  {
    ...
    rules: [
      "Software used for Programming will be 8085 simulators.",
      "Total time given will be 60 minutes for 1st round.",
      "Total time given will be 90 minutes for 2nd round.",
      "There will be no negative marking for the questions for both rounds.",
    ],
    prize: [4000, 2500, 1500, 1000],
    eventHeadName: ["Rohit Kumar"],
    eventHeadNumber: ["6205952898"],
  ...
  },
  {
    ...
    prize: [6000, 3500, 2500, 1500],
    eventHeadName: ["Omkar Pandey"],
    eventHeadNumber: ["9546762776"],
  ...
  },
  {
    ...
    prize: [4000, 3000, 2000, 1000],
    eventHeadName: ["Vikash Kumar"],
    eventHeadNumber: ["7061492419"],
  ...
  },
  {
    ...
    rules: [
      "Round 1 will be played in 2 halves.",
      ...
      "Round 2: Two bots of qualifying teams will compete against each other.",
  ...
  },
  {
    ...
    rules: [
      ...
      "Round 1:",
      "• The first round will have an aptitude test which will test mathematical and  logical knowledge of the participants through a time based MCQ test. • The test will have to be taken by the team captain alone and it will be in  offline mode. • The round will be an elimination round and only the team captains that clear  the cut off will have their teams proceeding in the next round",
      "Round 2:",
      "• The second round will be a case-submission round.• A problem statement will be rolled out and so will be the questionnaire with  it. • The case submission will be made in the form of a power-point presentation  and will have to be submitted before the deadline. • The case study will comprise of two different sections yet under the same  case, the quantitative and the qualitative section.  • Both sections will have their separate cut-offs, only the teams making it past  the two cut-offs will make it to the next round.  ",
      "Round 3:",
      "• This is the third and the final round will be a case presentation and debriefing  round. • The case solution that the teams have presented will be presented and  evaluated before a panel of judges and relevant cross-questions will be  asked. • The judging of the solution and presentation will be on the criteria of the  overall solution. The feasibility of it, the cost-effectiveness and the team’s  overall understanding of the goals of the case. • The team excelling the presentation will be crowned the winner.",
      "General Rules",
  ...
  },
  {
    ...
    rules: [
      ...
      "General Rules",
      "• One team shall comprise of max 3 members. • There is no one correct solution to the case. The scoring shall be based on the  following parameters – Business Vigour, Research skills, Presentation skills, Creativity,  Uniqueness and relevance of the solution. • The final decision for the event rest with the judges.",
    ],
    prize: [5000, 3000, 2000, 1000],
  ...
  },
  {
    ...
    rules: [
      "The event comprises of 2 round.",
      "Round 1:",
      " The participants have to develop an ML model for the given problem  statement with the provided data set, and submit a CSV file of the final output of the  problem. A total of 6-8 teams will be selected for the final round. ",
      "Round 2:",
      "Every team have to present the PPT showing their approach for the  solution. ",
      "General Rules",
  ...
  },
  {
    ...
    rules: [
      "Design Report Submission : All the teams need to submit an abstract on their aircraft, which should be no longer than 10 pages. The design report should include the following crucial points about the aircraft: ",
      "It must contain the team name, a list of members, and the name of the institute.",
      "Design Analysis of Airfoil Selection, Wing Design, Tail Design, etc.",
      "Aerodynamic Analysis with Relevant Graphs",
      "Relevant Calculations",
      "Materials used and pictures of the manufacturing process (proof of fabrication)",
      "Avionics Selection",
      "Name of DR should be-Team Name_College",
      "DR is to be submitted in PDF form only.",
      "Presentation Round:-",
      "Teams are required to give a presentation explaining their approach to design, methodologies applied, and parameters considered when designing their aircraft.",
      "Flight Round:",
      "There will be two flight rounds in the competition.",
...

  {
    ...
    eventName: "CHESS",
    teamSize: "1",
    about: "Duration: 60 min Format: 5+3 (5 min with 3-sec increments) | Standard | Lichess Swiss
",
    rules: [
